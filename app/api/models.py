...
class TextClassificationProject(Project):
    ...
    @property
    def image(self):
        return staticfiles_storage.url('assets/images/cats/text_classification.png')
...
class SequenceLabelingProject(Project):
    ...
    @property
    def image(self):
        return staticfiles_storage.url('assets/images/cats/sequence_labeling.png')
...
class Seq2seqProject(Project):
    ...
    @property
    def image(self):
        return staticfiles_storage.url('assets/images/cats/seq2seq.png')
